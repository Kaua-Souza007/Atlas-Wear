...
- Seleção e cadastro de produtos;
- Armazenamento e controle de estoque;
- Exposição dos produtos no site;
- Realização de pedidos pelos clientes;
- Processamento e envio das compras.
...
- Atendimento online (site e redes sociais);
- Respostas rápidas a dúvidas;
...
• Missão
Oferecer roupas de qualidade que valorizem o estilo e a identidade de cada cliente.

• Visão
Tornar-se referência no mercado de moda, destacando-se pela inovação e excelência.
...
- Direção / Gestão → planejamento e decisões estratégicas;
- Vendas → atendimento ao cliente e pedidos;
- Estoque e Logística → organização e envio dos produtos;
